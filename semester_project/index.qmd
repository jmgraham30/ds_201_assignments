...
The second component of the semester project is your raw data together with a draft of your data sheet. 
...
The third component of the semester project is the results of your exploratory data analysis (EDA) for your chosen data set. This should include all the code you used to conduct an EDA together with a document that describes what you did and what you learned from the EDA. 


### Project Component 4

The fourth component of your semester project should be the results of your full analysis of your data. This can be any type of model as long as it is appropriate for your data set and you can justify why you used the type of model you did. This should include all the code and data needed to reproduce your results. 

### Final Submission

The final submission for your semester project should consist of:
