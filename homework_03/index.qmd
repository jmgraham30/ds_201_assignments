...
a. Based on the plot, how would you describe the relationship between body mass vs. flipper length?

b. Is the relationship between body mass vs. flipper length different for different species?

c. Does the plot indicate any difference between the different species of penguins? If so, explain the differences. 

d. What aesthetics are used in the plot for @fig-fancy-fig? Describe how the different aesthetics are used. 

e. Do you think the plot in @fig-fancy-fig is effective? Explain why or why not. 
