...
Obtain some data that is of interest to you from one of the data sources listed in [Appendix B](https://tellingstorieswithdata.com/21-datasets.html) of *Telling Stories with Data*. [View Appendix B](https://tellingstorieswithdata.com/21-datasets.html). You should document the data collection process by addressing:
